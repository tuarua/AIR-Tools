...
set CLASSPATH=%DIRNAME%lib\sdk-common-26.0.0-dev.jar;%DIRNAME%lib\manifest-merger-26.0.0-dev.jar;%DIRNAME%lib\commons-logging-1.1.1.jar;%DIRNAME%lib\common-26.0.0-dev.jar
